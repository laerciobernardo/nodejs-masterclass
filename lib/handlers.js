...
handlers._checks.post = function(data, callback){
   ...
   if(!protocol || !url || !method || !successCodes || !timeoutSeconds) return callback(400, {'Error': 'Missing required fields or are invalid'});
...
handlers._checks.get = function(data, callback){
   ...
   _data.read('checks', id, function(err, checkData){
      ...
      handlers._tokens.verifyToken(token, checkData.userPhone, function(isValid){
         ...
         //Lookup the user
         _data.read('users', checkData.userPhone, function(err, data){
...
handlers._checks.put = function(data, callback){
   ...
   if( !id || (!protocol && !url && !method && !successCodes && !timeoutSeconds)) return callback(400, {'Error': 'Missing required fields, are invalid or missing fields to update'});
